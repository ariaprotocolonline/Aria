...
export const env = {
  ...
  USDY_ADDRESS_MAINNET: get('VITE_USDY_ADDRESS_MAINNET', '0x5bE26527e817998A7206475496fDE1E68957c5A6'),
  METH_ADDRESS_MAINNET: get('VITE_METH_ADDRESS_MAINNET', '0xcDA86A272531e8640cD7F1a92c01839911B90bb0'),
  // Testnet: deploy mocks and fill these in
  USDY_ADDRESS_TESTNET: get('VITE_USDY_ADDRESS_TESTNET', '0x0000000000000000000000000000000000000000'),
  METH_ADDRESS_TESTNET: get('VITE_METH_ADDRESS_TESTNET', '0x0000000000000000000000000000000000000000'),
