  ...
  return (
    <section className="py-24 md:py-32 flex flex-col items-center justify-center text-center px-6">
      ...
      <motion.h2
        ...
        className="font-serif text-3xl md:text-5xl max-w-4xl text-text-primary leading-tight mb-6"
      >
      ...
      >
        <button
          ...
          className="bg-accent text-white px-8 py-3.5 rounded-sm font-semibold tracking-wide hover:opacity-90 transition-opacity"
          onClick={openConnectModal}
        >
          Connect Wallet
        </button>
        <button className="bg-transparent border border-soft text-text-primary px-8 py-3.5 rounded-sm font-medium hover:bg-bg-soft transition-colors flex items-center justify-center gap-2">
